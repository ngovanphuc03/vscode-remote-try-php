    ...
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li>
                    <a itemprop="url" href="#" title="Account"><span itemprop="title">Tài khoản</span></a>
                </li>
        ...
        <div class="auth" style="background: white;">
            <form class="from_cart_register" action="" method="post" style="width: 500px;margin:0 auto;padding: 30px 0">
                ...
                <div class="form-group">
                    ...
                    <input name="phone" id="phone" type="number" value="<?php echo e(old('phone')); ?>" placeholder="090099999" class="form-control">
...
<?php echo $__env->make('layouts.app_master_frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\book_store_lavarel\resources\views/auth/register.blade.php ENDPATH**/ ?>