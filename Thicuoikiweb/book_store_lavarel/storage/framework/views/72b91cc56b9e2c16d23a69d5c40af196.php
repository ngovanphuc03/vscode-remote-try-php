            ...
            <div class="card">
                <div class="card-body login-card-body">
                    ...
                    <?php if(session('danger')): ?>
                        <p class="login-box-msg text-danger"><?php echo e(session('danger')); ?></p>
                    <?php endif; ?>
...
<?php /**PATH C:\Users\khai.dv\Desktop\book_store_laravel\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>