    ...
    <div class="container">
        <div class="breadcrumb">
            <ul>
                ...
                <li >
                    <a href="<?php echo e(route('get.blog.home')); ?>" title="Account"><span itemprop="title">Bài viết</span></a>
                </li>
                <li >
                    <a href="javascript://" title="Account"><span itemprop="title"><?php echo e($article->a_name); ?></span></a>
                </li>
            </ul>
        </div>
        <div class="blog-main">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app_master_frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\khai.dv\Desktop\book_store_laravel\resources\views/frontend/pages/article_detail/index.blade.php ENDPATH**/ ?>