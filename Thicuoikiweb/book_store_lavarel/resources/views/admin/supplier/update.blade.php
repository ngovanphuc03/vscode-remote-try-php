...
@section('content')
    ...
    <section class="content">
        <form role="form" action="{{ route('admin.ncc.excuteUpdate', ['id' => $supplier->id]) }}" method="POST">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-9">
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group {{ $errors->first('sl_name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ $supplier->sl_name }}" name="sl_name"
                                    placeholder="Name ...">
                            ...
                            <div class="form-group {{ $errors->first('sl_phone') ? 'has-error' : '' }}">
                                ...
                                <input type="number" class="form-control" value="{{ $supplier->sl_phone }}" name="sl_phone"
                                    placeholder="Phone ...">
                            ...
                            <div class="form-group {{ $errors->first('sl_email') ? 'has-error' : '' }}">
                                ...
                                <input type="email" class="form-control" value="{{ $supplier->sl_email }}" name="sl_email"
                                    placeholder="Email ...">
                            ...
                            <div class="form-group {{ $errors->first('sl_address') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ $supplier->sl_address }}"
                                    name="sl_address" placeholder="Address">
