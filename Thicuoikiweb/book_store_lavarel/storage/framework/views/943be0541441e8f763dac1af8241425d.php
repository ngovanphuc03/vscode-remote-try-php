                        ...
                        <div class="row">
                                ...
                                <div class="card card-primary">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group <?php echo e($errors->first('e_link') ? 'has-error' : ''); ?>">
                                            ...
                                            <input type="text" class="form-control" name="e_link"
                                                placeholder="Link ...">
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="min-height: 288px;overflow-x: hidden">
                                        <div class="form-group">
                                            <div class="input-group input-file" name="e_banner">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default btn-choose" type="button">Chọn
                                                        tệp</button>
                                                </span>
                                            ...
                                            <?php if(isset($category) && !empty($category->c_banner)): ?>
                                                <img src="<?php echo e(asset(pare_url_file($category->c_banner))); ?>" alt=""
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\book_store_lavarel\resources\views/admin/event/create.blade.php ENDPATH**/ ?>