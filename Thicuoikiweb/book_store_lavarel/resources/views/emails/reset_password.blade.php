<div style="width: 100%;max-width: 600px;margin:0 auto">
    ...
    <div style="background: #f4f5f5;box-sizing: border-box;padding: 15px">
        <p style="margin:2px 0;color: #333">Email : nhib1910271@student.ctu.edu.vn</p>
        <p style="margin:2px 0;color: #333">Phone : 0766827652</p>
        <p style="margin:2px 0;color: #333">Face : <a href="https://www.facebook.com/chucnhi.le.7">Chúc Nhi</a></p>
    </div>
</div>