                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="min-height: 288px">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger "><p class="mg-t-5"><?php echo e($errors->first('e_banner')); ?></p></span>
                                            <?php if(isset($event) && !empty($event->e_banner)): ?>
                                                <img src="<?php echo e(asset(pare_url_file($event->e_banner))); ?>" alt="" class="margin-auto-div img-rounded"  id="image_render" style="height: 150px; width:100%;">
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('admin/dist/img/no-image.png')); ?>" alt="" class="margin-auto-div img-rounded"  id="image_render" style="height: 150px; width:100%;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\book_store_lavarel\resources\views/admin/event/update.blade.php ENDPATH**/ ?>